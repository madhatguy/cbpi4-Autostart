...
INSERT OR IGNORE INTO config (name, value, type, description, options) VALUES ('OPEN_ON_SYSTEM_STARTUP', 'No', 'select', 'Exit the App and Start it Manually to Apply Changes. **Works only on RaspberryPi**', '[{"value": "Yes", "label": "Yes"}, {"value": "No", "label": "No"}]');
